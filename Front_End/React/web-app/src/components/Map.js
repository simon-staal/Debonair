...
function Map(){
    ...
    const handleClick=(event)=>{ 
        ...
        axios.post('https://debonair.duckdns.org:8080/move', { 'direction':'L' } )
            .then(response=>{
        ...
        axios.post('https://debonair.duckdns.org:8080/move', { 'direction':'S' } )
            .then(response=>{
                console.log(JSON.stringify(response.data));
            })
            .catch(err => {
    ...
    const handleClick2=(event)=>{
        ...
        axios.post('https://debonair.duckdns.org:8080/move', { 'direction':'F' })
            .then(response=>{
                console.log(JSON.stringify(response.data));
            })
            .catch(err => {
    ...
    const handleClick3=(event)=>{
        ...
        axios.post('https://debonair.duckdns.org:8080/move', { 'direction':'B' } )
            .then(response=>{
                console.log(JSON.stringify(response.data));
            })
            .catch(err => {
    ...
    const handleClick4=(event)=>{
        ...
        axios.post('https://debonair.duckdns.org:8080/move', { 'direction':'R' } )
            .then(response=>{
                console.log(JSON.stringify(response.data));
            })
            .catch(err => {
